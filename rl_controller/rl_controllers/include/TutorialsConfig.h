  ...
  public:
    ...
    void setParams(TutorialsConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("kp_test"==(*_i)->name){kp_test = boost::any_cast<double>(val);}
        if("kd_test"==(*_i)->name){kd_test = boost::any_cast<double>(val);}
        if("pos_des_test"==(*_i)->name){kp_test = boost::any_cast<double>(val);}
        if("ff_test"==(*_i)->name){kd_test = boost::any_cast<double>(val);}
      }
    }
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      ...
      __min__.kp_test = 0.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.kp_test = 10.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.kp_test = 0.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(TutorialsConfig::AbstractParamDescriptionConstPtr(new TutorialsConfig::ParamDescription<double>("kp_test", "double", 6, "kp_test", "", &TutorialsConfig::kp_test)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(TutorialsConfig::AbstractParamDescriptionConstPtr(new TutorialsConfig::ParamDescription<double>("kp_test", "double", 6, "kp_test", "", &TutorialsConfig::kp_test)));
